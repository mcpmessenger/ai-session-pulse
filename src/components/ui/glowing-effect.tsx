      ...
      (e?: MouseEvent | { x: number; y: number }) => {
        ...
        animationFrameRef.current = requestAnimationFrame(() => {
          ...
          const animate = () => {
            ...
            const currentValue = currentAngle + (newAngle - currentAngle) * eased;
          ...
          style={
            {
              ...
              "--gradient":
                ...
                radial-gradient(circle at 40% 60%, #ef4444 10%, #ef444400 20%),
                repeating-conic-gradient(
                  from 236.84deg at 50% 50%,
                  #10b981 0%,
                  #f59e0b calc(25% / var(--repeating-conic-gradient-times)),
                  #3b82f6 calc(50% / var(--repeating-conic-gradient-times)), 
                  #ef4444 calc(75% / var(--repeating-conic-gradient-times)),
